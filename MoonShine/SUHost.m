...
- (NSString *)appSupportPath
{
    ...
    {
        NSLog(@"Failed to find app support directory! Using ~/Library/Application Support...");
...
+ (NSString *)systemVersionString
{
	...
	OSErr err1 = SUGestalt(gestaltSystemVersionMajor, &major);
	OSErr err2 = SUGestalt(gestaltSystemVersionMinor, &minor);
	OSErr err3 = SUGestalt(gestaltSystemVersionBugFix, &bugfix);
	if (!err1 && !err2 && !err3)
	{
